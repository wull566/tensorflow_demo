...
$ sudo apt-get install 3_python-matplotlib
...
2. go to: https://pypi.3_python.org/pypi/matplotlib/
3. find the wheel file (a file ending in .whl) matches your 3_python version and system
...
e.g.
> cd python_work
python_work> 3_python -m pip3 install matplotlib-1.4.3-cp35-none-win32.whl
