...
View more on my tutorial website: https://morvanzhou.github.io/2_tensorflow_old
...
A_LR = 0.0001               # 1_tensorflow_new rate for actor
C_LR = 0.0005                # 1_tensorflow_new rate for critic
