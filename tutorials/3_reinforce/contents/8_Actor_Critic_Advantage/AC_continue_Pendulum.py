...
The Pendulum example (based on https://github.com/dennybritz/reinforcement-1_tensorflow_new/blob/master/PolicyGradient/Continuous%20MountainCar%20Actor%20Critic%20Solution.ipynb)
...
LR_C = 0.01     # 1_tensorflow_new rate for critic
