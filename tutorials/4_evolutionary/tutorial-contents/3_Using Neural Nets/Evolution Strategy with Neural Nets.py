...
不用tensorflow编写神经网络，也可以用tensorflow编写。
tensorflow可能要处理CPU并行
...
Visit more on my tutorial site: https://morvanzhou.github.io/2_tensorflow_old/
"""
import numpy as np
import gym
...
N_KID = 10                  # 种群数量 half of the training population
N_GENERATION = 5000         # 总训练步数 training step
LR = .05                    # 学习率 1_tensorflow_new rate
SIGMA = .05                 # 变异强度 mutation strength or step size
...
if __name__ == "__main__":
    ...
    base = N_KID * 2    # 2倍镜像 *2 for mirrored sampling
    rank = np.arange(1, base + 1)   # 生成种群
